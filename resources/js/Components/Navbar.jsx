...
const Navbar = ({user}) => {
  ...
  return (
  <div className="navbar bg-white px-[16px] pt-[24px]">
    <div className=" w-full flex justify-between">
        ...
        <button onClick={toggleCanvas}><svg className='absolute right-4 top-8' width="40" height="17" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fillRule="evenodd"><path d="M0 0h40v3H0zM0 7h40v3H0zM0 14h40v3H0z"/><path d="M0 0h40v3H0z"/></g></svg></button>
        {
        ...
        <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
          {
            !user ? 
              <>
                <Canvas user={user} toggleCanvas={toggleCanvas}></Canvas>
              </>
              :
              <>
                <li>
