    ...
    <div className='pt-[60px] flex flex-col gap-[34px] Laptop:flex-row Laptop:pt-[5px] pb-10'>
        <div className="flex gap-[24px] Laptop:w-[350px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <Link className="font-extrabold pb-2 text-[18px] hover:text-softRed" href={route('detail.show',{id: data[11].id})}>Reviving Retro PCs</Link> 
        ...
        <div className="flex gap-[24px] Laptop:w-[350px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <Link className="font-extrabold pb-2 text-[18px] hover:text-softRed" href={route('detail.show',{id: data[12].id})}>Top 10 Laptops of 2022</Link> 
            <p className="text-[15px] text-DGB">Our best picks for various needs and budgets.</p> 
          </div>
        </div>
        <div className="flex gap-[24px] Laptop:w-[350px]">
          <img className="h-[130px]" src="./build/assets/image//image-gaming-growth.jpg" href={route('detail.show',{id: data[12].id})} alt="" />
          <div className="flex flex-col justify-center">
            <h2 className="text-[32px] font-bold text-grayishBlue">03</h2>
            <Link className="font-extrabold pb-2 text-[18px] hover:text-softRed" href="#">The Growth of Gaming</Link> 
