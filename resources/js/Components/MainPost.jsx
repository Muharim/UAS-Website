  ...
  return (
    <div>
        <div className="pb-[60px] Laptop:flex Laptop:flex-col Laptop:gap-[40px]">
            <img className="relative bottom-[8px] pb-[18px] Laptop:hidden" src={`/build/assets/image/${data.image}`} alt="" />
            <div className='Laptop:flex Laptop:gap-[30px] Laptop:w-[740px]'>
              <h1 className="font-bold font-[32px] text-[40px] leading-none pb-[18px] Laptop:text-[54px] Laptop:w-[1100px]">{data.title}</h1>
              <div>
