...
function App() {
  ...
  return (
    <div className="pt-[28px] px-[16px] pb-[40px] font-Inter Laptop:px-[160px] Laptop:pt-[90px]">
      <div className="flex justify-between">
        ...
        <ul className="hidden Laptop:flex gap-8 relative top-1 text-DGB">
          ...
          <li><a className="hover:text-softRed"href="#">Log in</a></li> 
          <li><a className="hidden hover:text-softRed"href="#">Log out</a></li> 
        </ul> 
      ...
      <div className="pt-[60px] pb-[40px] flex flex-col gap-[34px] Laptop:flex-row Laptop:pt-[5px]">
        <PopularPost 
